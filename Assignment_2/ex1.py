...
model_predictor = ModelPredictor('HW2_Team13/model13.tflite')

parser = ap.ArgumentParser()
parser.add_argument('--device', type=int, default=0)
parser.add_argument('--host', type=str, default='redis-17092.c327.europe-west1-2.gce.cloud.redislabs.com')
parser.add_argument('--port', type=int, default= 17092)
parser.add_argument('--username', type=str, default= 'default')
parser.add_argument('--password', type=str, default='mLDh62zVOi0hqZJAfLRAtnv4IE8uTBhO')
...
def callback(indata, frames, callback_time, status):
    ...
    if len(buffer) == 16000:
        ...
        if predicted_silence is 0 and check_audio is True:
            ...
            if value == 0 and probability > 0.99:
                print('Start monitoring')
                monitoring = True
            elif value == 1 and probability > 0.99:
